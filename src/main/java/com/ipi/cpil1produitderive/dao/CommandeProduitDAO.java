...
public interface CommandeProduitDAO extends JpaRepository<CommandeProduit, Long> {
    ...
    @Query(value = "SELECT " +
            ...
            "INNER JOIN produit " +
            "ON commandeproduit.idProduit = produit.id " +
            "INNER JOIN commande " +
            "ON commandeproduit.idCommande = commande.id " +
            "WHERE commande.isPurchasedOnline = 0", nativeQuery = true)
    ...
    @Query(value = "SELECT " +
            ...
            "INNER JOIN commande " +
            "ON commandeproduit.idCommande = commande.id " +
            "WHERE commande.isPurchasedOnline = 1", nativeQuery = true)
    ...
    @Query(value = "SELECT " +
            ...
            "INNER JOIN commande " +
            "ON commandeproduit.idCommande = commande.id " +
            "WHERE commande.isPurchasedOnline = 1 " +
    ...
    @Query(value = "SELECT " +
            "SUM(commandeproduit.quantite * produit.prixAchat) " +
            "FROM commandeproduit INNER JOIN produit " +
            "ON commandeproduit.idProduit = produit.id " +
            "INNER JOIN commande " +
            "ON commandeproduit.idCommande = commande.id " +
    ...
    //Marge Brut dégagé
    @Query(value = "SELECT " +
            "SUM(commandeproduit.quantite * produit.prixVente) " +
            "FROM commandeproduit " +
            "INNER JOIN produit " +
            "ON commandeproduit.idProduit = produit.id " +
            "INNER JOIN commande " +
